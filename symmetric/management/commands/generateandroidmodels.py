...
class Command(BaseCommand, GenerateModelsCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.mappings = {'ivars': ivar_mapping, 'read_json': read_json_mapping, 'write_json': write_json_mapping, 'read_parcel': read_parcel_mapping, 'write_parcel': write_parcel_mapping, 'read_external': read_external_mapping, 'write_external': write_external_mapping }
